  ...
  return (
    <div className="home">
      ...
      <div className="home__row">
        <Product
          id="3"
          title="Lamkei Sports LAM-1284 Black Dial White Transport Silicone Strap Analogue"
        ...
        <Product
          id="4"
          title="EMERA Mens's Solid Cotton Long Sleeve Round Neck Shrug"
      ...
      <div className="home__row">
        <Product
          id="6"
          title="Redmi 8A Dual (Sea Blue,2GB RAM,32GB Storage) - Dual Camera & 5,000 mAH Battery"
